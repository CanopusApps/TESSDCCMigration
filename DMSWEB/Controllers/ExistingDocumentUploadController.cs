            ...
            try
            {
                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        //    objDoc.EditableFilePath = CommonMethods.CombineUrl(objDoc.ProjectName, QMSConstants.EditableFolder, objDoc.DepartmentName, objDoc.SectionName, objDoc.DocumentCategoryName);
                        //}
                        //else if (i == 1)
                        //{
                        //    objDoc.ReadableByteArray = fileByteArray;
                        //    objDoc.ReadableDocumentName = objDoc.DocumentNo + Path.GetExtension(file.FileName);
                        //    objDoc.ReadableFilePath = CommonMethods.CombineUrl(objDoc.ProjectName, QMSConstants.ReadableFolder, objDoc.DepartmentName, objDoc.SectionName, objDoc.DocumentCategoryName);
                        //}
                    }                    
                }
