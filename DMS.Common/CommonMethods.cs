...
namespace DMS.Common
{
    public static class CommonMethods
    {
        ...
        {
            Hashtable metaData = new Hashtable(){{SharePointConstants.DocumentID,objDoc.ID.ToString()},
                                                {SharePointConstants.DocumentNo,objDoc.DocumentNumber.ToString()},
                                                ...
                                                {SharePointConstants.DocumentCategoryName,objDoc.ClassificationID}};
            return metaData;
        }
        ...
        public static DraftDocument GetDocumentObject(DataRow dr)
        {
            ...
            try
            {
                ...
                if (dr.Table.Columns.Contains("DocumentPublishID") && dr["DocumentID"] != DBNull.Value)
                    objDocument.ID = new Guid(dr["DocumentID"].ToString());
                ...
                if (dr["WFExecutionID"] != DBNull.Value)
                    objDocument.ExecutionID = (Guid)dr["WFExecutionID"];
        ...
        public static void SendMail(string toEmail, string subject, string messageBody)
        {
            try
            {
                ...
                string password = ConfigurationManager.AppSettings["EmailPassword"].ToString(); //"2@Chakalakonda";
